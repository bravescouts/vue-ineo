<template>
    <div id="JobEditor">
    <!-- form dialog -->
<el-dialog title="Job Record" :visible.sync="dialogFormVisible">
<el-form :model="form">
...
<el-form-item label="Supervisor" :label-width="formLabelWidth">
  <el-input v-model="form.supervisor" autocomplete="off"></el-input>
</el-form-item>
